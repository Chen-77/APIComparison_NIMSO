...
def main(args):
    ...
    # data
    train_data_file = os.path.join(args.data_dir, "Rel_train.json")
    valid_data_file = os.path.join(args.data_dir, "Rel_dev_new.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--resume', type=int, nargs="?", const=True, default=True, help='resume most recent training'
    )
