...
class PerformanceProcessor(DataProcessor):
  ...
  def get_train_examples(self, data_dir):
    ...
    return self._create_examples(
        self._read_data(os.path.join(data_dir, "Rel_data.txt")), "train")

  def get_dev_examples(self, data_dir):
    """See base class."""
    return self._create_examples(
        self._read_data(os.path.join(data_dir, "RelSingle_data_dev_sec.tsv")), "dev")

  def get_test_examples(self, data_dir):
    """See base class."""
    return self._create_examples(
        self._read_data(os.path.join(data_dir, "RelSingle_data_dev_sec.tsv")), "test")
...
class UsabilityProcessor(DataProcessor):
  ...
  def get_test_examples(self, data_dir):
    """See base class."""
    return self._create_examples(
        self._read_data(os.path.join(data_dir, "WOSingle_test.tsv")), "test")
