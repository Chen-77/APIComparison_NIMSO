...
class NerProcessor(DataProcessor):
    ...
    #         self._read_data(os.path.join(data_dir, "Entitytraindata.txt")), "train"
    #     )
    #
    # def get_dev_examples(self, data_dir):
    #     return self._create_example(
    #         self._read_data(os.path.join(data_dir, "Top1-5912_entitydata.txt")), "dev"
    #     )
    #
    # def get_test_examples(self,data_dir):
    #     return self._create_example(
    #         self._read_data(os.path.join(data_dir, "Top1-5912_entitydata.txt")), "test"
    #     )
    #
    #
    # def get_labels(self):
    ...
    def get_test_examples(self, data_dir):
        fr = open(os.path.join(data_dir, 'Top1-5912_allsenpair.tsv'), encoding='utf-8')
...
def convert_single_example(ex_index, example, label_list, max_seq_length, tokenizer, mode):
    ...
    while len(input_ids) < max_seq_length:
        ...
        ntokens.append("[PAD]")
    # ntokens:["[CLS]","当","希","望"], mask=[1,1,1,1],input_ids=[101,256,257,412],label_ids=[8,1,1,1]
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(label_ids, logits, num_labels, mask):
                ...
                conf_mat = metrics.get_metrics_ops(label_ids, predictions, num_labels, weights=mask) 
